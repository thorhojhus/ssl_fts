...
python -u run_longExp.py \
  ...
  --enc_in 7 \
  --des 'Exp' \
  --itr 1 --batch_size 32 --learning_rate 0.001 >logs/LongForecasting/${logname}_"$pred_len".log
...
python -u run_longExp.py \
  ...
  --enc_in 7 \
  --des 'Exp' \
  --itr 1 --batch_size 32 --learning_rate 0.1 >logs/LongForecasting/${logname}_"$pred_len".log
